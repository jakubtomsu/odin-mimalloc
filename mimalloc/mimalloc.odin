...
block_visit_fun :: #type proc "c" (heap: Heap, area: ^heap_area_t, block: rawptr, block_size: uint, arg: rawptr) -> bool
deferred_free_fun :: #type proc "c" (force: bool, heartbeat: uint, arg: rawptr)
output_fun :: #type proc "c" (msg: cstring, arg: rawptr)
error_fun :: #type proc "c" (err: int, arg: rawptr)
...
// Internals
// ------------------------------------------------------
register_deferred_free :: proc(deferred_free: deferred_free_fun, arg: rawptr) ---
register_output :: proc(out: output_fun, arg: rawptr) ---
register_error :: proc(fun: error_fun, arg: rawptr) ---

collect :: proc(force: bool) ---
version :: proc() -> int---
stats_reset :: proc() ---
stats_merge :: proc() ---
stats_print :: proc(out: rawptr) ---   // backward compatibility: `out` is ignored and should be NULL
stats_print_out :: proc(out: output_fun, arg: rawptr) ---

process_init :: proc() ---
thread_init :: proc() ---
thread_done :: proc() ---
thread_stats_print_out :: proc(out: output_fun, arg: rawptr) ---

process_info :: proc(elapsed_msecs: ^uint, user_msecs: ^uint, system_msecs: ^uint,
  current_rss: ^uint, peak_rss: ^uint,
  current_commit: ^uint, peak_commit: ^uint, page_faults: ^uint) ---
...
heap_visit_blocks :: proc(heap: Heap, visit_all_blocks: bool, visitor: block_visit_fun, arg: rawptr) -> bool ---
...
arena_area :: proc(arena_id: arena_id_t, size: ^uint) -> rawptr ---
reserve_huge_os_pages_at_ex :: proc(pages: uint, numa_node: int, timeout_msecs: uint, exclusive: bool, arena_id: ^arena_id_t) -> int ---
reserve_os_memory_ex :: proc(size: uint, commit: bool, allow_large: bool, exclusive: bool, arena_id: ^arena_id_t) -> int ---
manage_os_memory_ex :: proc(start: rawptr, size: uint, is_committed: bool, is_large: bool, is_zero: bool, numa_node: int, exclusive: bool, arena_id: ^arena_id_t) -> bool---

when VERSION >= 182 {
	// Create a heap that only allocates in the specified arena
heap_new_in_arena :: proc(arena_id: arena_id_t) -> 	Heap ---
}
...
option_is_enabled :: proc(option: option_t) -> bool ---
option_enable :: proc(option: option_t) ---
option_disable :: proc(option: option_t) ---
option_set_enabled :: proc(option: option_t, enable: bool) ---
option_set_enabled_default :: proc(option: option_t, enable: bool) ---

option_get :: proc(option: option_t) -> int ---
option_get_clamp :: proc(option: option_t, min: int, max: int) -> int ---
option_get_size :: proc(option: option_t) -> uint ---
option_set :: proc(option: option_t, value: int) ---
option_set_default :: proc(option: option_t, value: int) ---
} // foreign lib